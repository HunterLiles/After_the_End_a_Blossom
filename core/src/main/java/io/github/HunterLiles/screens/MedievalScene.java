...
// Medieval Age level scene
public class MedievalScene extends BaseScene {
    // Scene constants
    private static final String SCENE_ID = "medieval_age";
    ...
    // Constructor
    public MedievalScene(Main game) {
        super(game);
